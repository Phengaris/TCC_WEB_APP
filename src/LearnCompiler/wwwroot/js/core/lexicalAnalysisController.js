var LexicalAnalysisController = function () {
    ...
    return {
        analysis: function (character) {
            ...
            switch (state) {
                /*
                 * The 1th case validates all entries
                 */
                case "1":
        ...
        dyeImage: function (canvas, context, coordinates) {
            ...
            for (var y = coordinates.height_start; y < coordinates.height_end; y++) {
                for (var x = coordinates.width_start; x < coordinates.width_end; x++) {
